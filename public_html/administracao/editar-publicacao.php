...
$sql = sprintf('SELECT id, titulo, subtitulo, artista, estado, data de criacao, data da ultima modificacao
                FROM obra_artistica
    ...
    <form class='form' action='/src/editar_publicacao.php' method='post'>
        ...
        <div class='input-group'>
            ...
            <div class='input-field'>
                <i class='fas fa-user'></i>
                <select name='estado[]'>
                    <option value="<?= $row['estado'] ?>" selected hidden><?= $row['estado'] ?></option>
