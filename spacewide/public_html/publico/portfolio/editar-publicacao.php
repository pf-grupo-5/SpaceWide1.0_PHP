...
(!tipo_de_usuario_logado('artista')) ? (exit(header('Location: .index.php'))) : (null);
...
<body id="body">
 <div class="wrapper">
        <form class='form' action='/src/editar_publicacao.php' method='post'>
            ...
            <div class='input-group'>
                ...
                <div class='inputfield'>
                    <select class="input" name='estado[]'>
                        <option value="1" selected hidden><?= $row['estado']; ?></option>
            ...
            <button type='submit' class="btn" class='submit-btn' name='data-update-btn'>Atualizar</button>
