...
$sql = sprintf("SELECT * FROM usuario WHERE id = ?");
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/src/inc/css/publica.css">
...
<body>
    ...
    <div class="wrapper">
        ...
        <form class='form' action='/src/publicar_obra_artistica.php' method='post' enctype='multipart/form-data'>
            <div class="title">Publicar obra</div>
            <div class="form">
                ...
                <div class='inputfield'>
                    <input type='text'class="input" name='subtitulo' placeholder='tag'>
                </div>
