...
<div class="container">
        <div class="table-container">
            <form action="" method="GET">
               <div class="sort_box">
                    <select class="class="form-control me-2" name="sort" class="sort-control">
                    ...
                    <button type="sort-submit" name="sort-btn" class="btn btn-primary btn-sm">Filtrar</button>
                </div>
                
                <div class="search-box">
                    <input class="class="form-control me-2"" "type="search" name="search-bar" class="btn" value="<?php if(isset($_GET['search-bar'])) {echo $_GET['search-bar']; } ?>" >
                    <button type="search-submit" name="search-btn" class="btn btn-primary btn-sm">Buscar</button>
                </div>
            </form>
