...
<head>
    ...
    <title>Informações do portfolio</title>
</head>
...
<body>
    <header id="body">
        <div class="note">
            ...
            if (isset($_GET['portfolio'])) :
                ...
                $mensagem_de_portfolio = $_GET['portfolio'];

                if ($mensagem_de_portfolio == 'tipo_de_imagem_invalida'):
                    echo "<p>Este tipo de arquivo nao e suportado.</p>";
                elseif ($mensagem_de_portfolio == 'tamanho_de_imagem_invalido'):
                    echo "<p>A imagem deve ter no maximo 10MB.</p>";
                elseif ($mensagem_de_portfolio == "erro"):
                    echo "<p>Um erro ocorreu, tente novamente.</p>";
                elseif ($mensagem_de_portfolio == 'erro_na_imagem'):
                    echo "<p>A imagem pode esta corrompida.</p>";
                elseif ($mensagem_de_portfolio == 'upload_incompleto'):
                    echo "<p>Ocorreu um erro durante o upload, tente novamente.</p>";
                elseif ($mensagem_de_portfolio == 'portfolio_atualizado'):
                    echo "<p>Portfolio atualizado com sucesso :)</p>";
                endif;
    ...
    <div class="wrapper">
        ...
        <form class="form"  action="/src/editar_portfolio.php" method="post" enctype="multipart/form-data">
