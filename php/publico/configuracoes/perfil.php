...
<body>
    <header id="body">
        <div class="note">
            ...
            if (isset($_GET['perfil'])) :
                ...
                $mensagem_de_perfil = $_GET['perfil'];

                if ($mensagem_de_perfil == 'tipo_de_imagem_invalida'):
                    echo "<p>Este tipo de arquivo nao e suportado.</p>";
                elseif ($mensagem_de_perfil == 'tamanho_de_imagem_invalido'):
                    echo "<p>A imagem deve ter no maximo 10MB.</p>";
                elseif ($mensagem_de_perfil == "erro"):
                    echo "<p>Um erro ocorreu, tente novamente.</p>";
                elseif ($mensagem_de_perfil == 'erro_na_imagem'):
                    echo "<p>A imagem pode esta corrompida.</p>";
                elseif ($mensagem_de_perfil == 'upload_incompleto'):
                    echo "<p>Ocorreu um erro durante o upload, tente novamente.</p>";
                elseif ($mensagem_de_perfil == 'perfil_atualizado'):
    ...
    <div class="wrapper">
        ...
        <?php if ($_SESSION['acesso'] != 'atista'): ?>

        <a href="/src/cadastrar_artista.php">Transformar-se em artista</a>

        <?php endif; ?>

        <a href="/src/deletar_conta.php">Deletar conta</a>
