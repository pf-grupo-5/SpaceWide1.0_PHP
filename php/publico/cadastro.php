...
require($_SERVER['DOCUMENT_ROOT'] . '/src/libs/acesso/ja_logado.libs.php');
...
<body>
    ...
    <div class="wrapper">
        <form class='form'  action='/src/cadastrar_cliente.php' method='post'>
            ...
            <div class="form">
                ...
                <div class="inputfield terms">
                    ...
                    <p>Eu também concordo com os <a href=#>termos de serviço</a></p>
                </div>
            
                <div class="inputfield terms">
                    <label class="check">
                        <input type="checkbox" name='termos-de-privacidade' required/>
                        <span class="checkmark"></span>
                    </label>
                    <p>Eu concordo com os <a href=#>termos de privacidade</a></p>
                </div>
