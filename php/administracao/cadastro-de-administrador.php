...
<body>
    ...
    <div class="wrapper">
        <form class='form'  action='/src/cadastrar_administrador.php' method='post'>
            ...
            <div class="form">
                ...
                <div class="inputfield">
                    <button type="submit" value="Register" class="btn" name="submit">Cadastrar administrador</button>
                </div>
            </div>
        </form>
    </div>
